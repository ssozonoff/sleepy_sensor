...
#define PERM_RECV_ALERTS_HI    (1 << 7)   // high priority alerts
  ...
  #define FIRMWARE_BUILD_DATE   "13 Dec 2025"
#endif
...
// - Set to a zone name (e.g., "sensor", "building-a") to enable transport codes
// - Set to "" to disable zones and use standard flooding (all repeaters forward)
// - Can be changed at runtime via "zone set <name>" CLI command
// - Matching repeaters must be configured with the same zone via region management
#ifndef DEFAULT_BROADCAST_ZONE
  #define DEFAULT_BROADCAST_ZONE "sensor"  // Default zone name, set to "" to disable
#endif
...
public:
  ...
  int getSleepInterval(uint8_t default_value);
